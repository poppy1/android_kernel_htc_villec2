...
export ARCH=arm
export CROSS_COMPILE=$HOME/mokee/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/arm-eabi-

## Build kernel using villec2_defconfig
make villec2_defconfig
...
# build flashable zip
     ...
     cd Packages/out/
     zip -r ../villec2-kernel-$usr-$curdate.zip .
